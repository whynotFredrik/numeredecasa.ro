  ...
  return (
    <main className="min-h-screen pt-24 pb-12 px-6 lg:px-12 bg-foreground/[0.02]">
      <article className="max-w-3xl mx-auto prose prose-lg prose-headings:font-bold prose-headings:tracking-tight prose-a:text-primary">
        ...
        <h2>1. Date Firmă</h2>
        <p>Magazinul online <strong>numarul.ro</strong> este operat de <strong>SC GUNDAHAR SRL</strong>, cu sediul social în Str. Feleacului 14, Oradea, România, CUI: 36704546. Email de contact: contact@numarul.ro, Telefon: 0756 210 895.</p>
