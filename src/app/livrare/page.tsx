...
export const metadata = {
  ...
  description: 'Informații despre livrarea produselor numarul.ro prin curier la domiciliu sau locker/easybox.',
};
  ...
  return (
    <main className="min-h-screen pt-24 pb-12 px-6 lg:px-12 bg-foreground/[0.02]">
      <article className="max-w-3xl mx-auto prose prose-lg prose-headings:font-bold prose-headings:tracking-tight prose-a:text-primary">
        ...
        <p className="text-foreground/60 text-sm">Ultima actualizare: 17 martie 2026</p>

        <h2>1. Metode de Livrare</h2>
        <p>Livrarea produselor comandate pe numarul.ro se realizează pe teritoriul României, prin intermediul platformei <strong>WOOT</strong> (woot.ro), un broker de expediții care colaborează cu mai mulți curieri naționali și internaționali (Fan Courier, Sameday, DPD, Cargus, GLS, și alții). Oferim două metode:</p>
        ...
        <h3>Locker / Easybox</h3>
        <ul>
          <li>Coletul este livrat în locker-ul selectat de tine la checkout</li>
